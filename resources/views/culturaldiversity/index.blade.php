          ...
          <div class="card border shadow-xs mb-4 mt-4">
            <div class="card-header border-bottom pt-1">
              <div class="d-sm-flex align-items-center">
                <div>
                  <h6 class="font-weight-semibold text-lg mb-0">Daftar Cultural Diversity</h6>
                </div>
                  ...
                  <tbody>
                    ...
                    <td class="align-middle text-center text-sm">
                      ...
                      <td class="align-middle text-center">
                        ...
                        <span class="text-secondary text-sm font-weight-normal"> Akhir Pekan: {{ $space->harga_weekend}}</span>
                      </td>
                      <td class="align-middle text-center">
