          ...
          <div class="col-12 text-center ">
            <div class="row text-center">
              <div class="col-lg-12">
                ...
                <h5 class="black-text">Cultural Divesitybudaya masa lalu dan budaya masa kini, baik yang bersifat berwujud (tangible) maupun tidak berwujud (intangible).
            keragaman Indonesia meliputi rumah adat, upacara adat, alat musik tradisional, pakaian adat, tarian adat, lagu daerah, senjata tradisional, hingga makanan khas.</h5>
                <hr>
            </div>
            </div>
          ...
          <div class="col-lg-4 text-center">
            ...
            <div class="container-contact100-form-btn">
                            <button class="contact100-form-btn">
                                <span><a href="{{ route('culturaldiversity2.show', $space->id) }}">
                                    Detail
                                </a></span>
                            </button>
                        </div>
