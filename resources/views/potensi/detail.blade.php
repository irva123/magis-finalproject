...
@section('navbar')
  <!-- Contact Start -->
        ...
        <div class="row">
            <div class="col-md-6 col-xs-6 ">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="black-text">{{ $geodiversity2->deskripsi }}</p>
                        </p>

                        <p>
                        <h5 class="black-text"><strong>Alamat :</strong></h5>
                        <p class="black-text">{{ $geodiversity2->alamat }}</p>
                        </p>

                        <p>
                        <h5 class="black-text"><strong>Titik Koordinat :</strong></h5>
                        <p class="black-text">{{ $geodiversity2->titik_koordinat }}</p>
                        </p>

                        <p>
                        <h5 class="black-text"><strong>Jam Operasional :</strong></h5>
                        <p class="black-text">{{ $geodiversity2->jam_buka}}</p>
                        </p>

                        <p>
                        <h5 class="black-text"><strong>Harga Weekday :</strong></h5>
                        <p class="black-text">{{ $geodiversity2->harga_weekday}}</p>
                        </p>

                        <p>
                        <h5 class="black-text"><strong>Harga Weekend :</strong></h5>
                        <p class="black-text">{{ $geodiversity2->harga_weekend}}</p>
                        </p>

                        <p>
                        <h5 class="black-text"><strong>Kontak :</strong></h5>
                        <p class="black-text">{{ $geodiversity2->kontak}}</p>
                        </p>

                        <p>
                        <h5 class="black-text"><strong>Sosial Media :</strong></h5>
                        <p class="black-text">{{ $geodiversity2->sosmed}}</p>
                        </p>
            ...
            <div class="card">
                    <div class="card-body">
                    <iframe src="{{ $geodiversity2->link_maps }}" width="490" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
