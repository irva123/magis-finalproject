          ...
          <div class=" ml-5 mb-2 pt-4 px-3">
            ...
            <div class="row">
                ...
                @foreach($category as $category)
                    <option @selected($category->id == $geodiversity->id_category) value="{{$category->id}}"  @class([
                'bg-purple-600 text-white' => $category->id == $geodiversity->id_category ])> {{ $category->nama }}</option>
                ...
                <option @selected($marker->id == $geodiversity->id_marker) value="{{$marker->id}}"  @class([
                'bg-purple-600 text-white' => $marker->id == $geodiversity->id_marker ])> {{ $marker->marker }}</option>
                ...
                <div class="col-6">
                    ...
                    name="nama" value = "{{ $geodiversity->nama}}">
                @error('nama')
                ...
                <div class="mb-3 col-6">
                    ...
                    name="alamat" value = "{{ $geodiversity->alamat}}">
                @error('alamat')
                <div class="invalid-feedback">
                {{ $messages }}
                </div>
                ...
                <div class="mb-3 col-6">
                    ...
                    name="titik_koordinat" value = "{{ $geodiversity->titik_koordinat}}">
                ...
                <div class="mb-3 col-6">
                    ...
                    name="link_maps" value = "{{ $geodiversity->link_maps}}">
                @error('link_maps')
                <div class="invalid-feedback">
                {{ $messages }}
                </div>
                ...
                <div class="mb-3 col-6">
                    ...
                    name="jam_buka" value = "{{ $geodiversity->jam_buka}}">
                @error('jam_buka')
                <div class="invalid-feedback">
                {{ $messages }}
                </div>
                ...
                <div class="mb-3 col-6">
                    ...
                    name="harga_weekday" value = "{{ $geodiversity->harga_weekday}}">
                @error('harga_weekday')
                <div class="invalid-feedback">
                {{ $messages }}
                </div>
                ...
                <div class="mb-3 col-6">
                    ...
                    name="harga_weekend" value = "{{ $geodiversity->harga_weekend}}">
                @error('harga_weekend')
                <div class="invalid-feedback">
                {{ $messages }}
                </div>
                ...
                <div class="mb-3 col-6">
                    ...
                    name="kontak" value = "{{ $geodiversity->kontak}}">
                @error('kontak')
                <div class="invalid-feedback">
                {{ $messages }}
                </div>
                ...
                <div class="mb-3 col-6">
                    ...
                    name="sosmed" value = "{{ $geodiversity->sosmed}}">
                @error('sosmed')
                <div class="invalid-feedback">
                {{ $messages }}
                </div>
                ...
                <div class="mb-3 col-12">
                    ...
                    name="deskripsi" value = "{{ $geodiversity->deskripsi}}">
                @error('deskripsi')
                <div class="invalid-feedback">
                {{ $messages }}
                </div> 
