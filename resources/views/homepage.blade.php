...
<section id="section0" class="slider-area"> 
	...
	<div class="abt-section mb-50">
        ...
        <div class="col-lg-6 col-md-12">
        <div class="abt-text">
						<img class="img-fluid shadow " src="img/bromo.jpg" alt="video-thumbnail">
						<div class="video-button video-box">
							<!-- Video Play Button -->
							<a href="https://youtu.be/TEXBgNVt19Q">
								<i class="ti-control-play" data-video="https://youtu.be/TEXBgNVt19Q"></i>
							</a>
                        </div>
					</div>
				</div>
            ...
            <div class="container">
                ...
                <div class="row shapes">
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        <div class="text-center mb-0">
                            <div class="col-md-12 minHeightProp">
                                <img  class="imgback"src="img/shape/geo.png" >
                            </div>
                            </div>
                            <div class="col-md-12">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="row">
                            <div class="col-md-12 minHeightProp">
                                <img class="imgback" src="img/shape/bio.png">
                            </div>
                            <div class="col-md-12">
                                <div class="text-center">
                                    <h4>Biodiversity</h4>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="row">
                            <div class="col-md-12 minHeightProp">
                                <img class="imgback" src="img/shape/cultural.png">
                            </div>
                            <div class="col-md-12">
                                <div class="text-center">
