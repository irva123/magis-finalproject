      ...
      <div class="container-fluid py-1 px-2">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-1 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">@yield('judul')</a></li>
            <li class="breadcrumb-item text-sm text-dark font-weight-bold active" aria-current="page">@yield('title')</li>
          </ol>
        </nav>
