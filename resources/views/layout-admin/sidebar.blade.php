      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item border-start my-0 pt-2">
          <a class="nav-link position-relative ms-0 ps-2 py-2 @yield('highlight2')" href="/geodiversity" >
            <span class="nav-link-text ms-1">Data Geoheritage</span>
          </a>
        </li>
        <li class="nav-item border-start my-0 pt-2">
          <a class="nav-link position-relative ms-0 ps-2 py-2 @yield('highlight2')" href="/geodiversity" >
            <span class="nav-link-text ms-1">Data Geodiversity</span>
          </a>
        </li>
        <li class="nav-item border-start my-0 pt-2">
          <a class="nav-link position-relative ms-0 ps-2 py-2 @yield('highlight4')" href="/biodiversity">
            <span class="nav-link-text ms-1">Data biodiversity</span>
          </a>
        </li>
        <li class="nav-item border-start my-0 pt-2">
        ...
        <li class="nav-item mt-2">
          <div class="d-flex align-items-center nav-link">
            ...
            <a class="nav-link  @yield('highlight3')" href="/kritik">
            <span class="font-weight-normal text-md ms-2 nav-link-text ">Kritik Dan Saran</span>
            </a>
          </div>
        </li>
