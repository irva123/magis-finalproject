...
<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.html"><img src="{{ url('storage/'.$space->foto) }}" alt=""></a>
            <h5><span class="black-text">{{ $space->nama }}</span></h5>
            <p><span class="black-text">{{ $space->tanggal_kegiatan }}</span></p>
