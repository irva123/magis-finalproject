  ...
  <!-- Contact Start -->
        ...
        <div class="row mt-5">
          ...
          <img class="img-fluid" width="500" height="300" src="{{ url('storage/'.$spaces->foto) }}"
                        ...
                        <p>
                        <p class="black-text2">{{ $spaces->deskripsi }}</p>
                        </p>
                      </br>
                      </br>
                      </br>
        <div class="row mb-10">
            ...
            <div class="card ">
                    <div class="card-body">
                    <iframe src="{{ $spaces->link_maps }}" width="600" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                  </div>
            </div>
        </div>
