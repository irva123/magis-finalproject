...
<section class="vh-100" style="background-color: #e6e6fa;">
  <div class="container py-2 h-110" >
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col col-md-9 col-lg-9 col-xl-9">
        <div class="card" style="border-radius: 15px; width: 650px; height: 450px">
            ...
            <div class="d-flex text-black mt-3">
              ...
              <div class="card mb-5">
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm-3">
                      <p class="mb-0">Id Event</p>
                    </div>
                    <div class="col-sm-3">
                      <p class="text-muted mb-0">: {{$event->id_event}}</p>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-3">
                      <p class="text-muted mb-0">: {{$event->alamat_kegiatan}}</p>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-3">
                      <p class="text-muted mb-0">: {{$event->tanggal_kegiatann}}</p>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-3">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-3">
                      <p class="text-muted mb-0">: {{$event->penyelenggara_kegiatan}}</p>
                    </div>
                  </div>
                </div>
              </div>
